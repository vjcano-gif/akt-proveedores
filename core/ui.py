...
PLANTILLAS = {
    ...
    "proveedores": ["codigo", "nombre", "nit", "ubicacion_desde",
                    "ubicacion_hasta", "tolerancia_averia_pct", "activo"],
...
EJEMPLOS = {
    ...
    "proveedores": [["VDR0013714", "Grupo DL Plus S.A.S", "900123456",
                     "UB-ORIGEN", "TPROC-INTE-AKT", "1.0", "TRUE"]],
